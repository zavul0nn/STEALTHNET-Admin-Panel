...
# Telegram Bot
CLIENT_BOT_TOKEN=your_telegram_bot_token - токен нашего бота
# Для интеграции бедолаги - либо нашего на выбор огда апи оставляете пустым
...
## ⚙️ Настройка NGINX и Бота 

## 4 Настройка Бота , загрузите файлы с папки frontend и проксируйте их ./nginx config examlpe.md есть пример конфинга 
   После того как проксируете все просто запустите client_bot.py и добавьте в автозагрузку !
## 5 СОВЕТ client_bot.py и app.py добавлять в автозагрузку тогда не будет проблем 
